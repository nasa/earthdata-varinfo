# sds-varinfo CHANGELOG

These release notes correspond to internal, pre-open-source publication of the
`earthdata-varinfo` package, which at that point was called `sds-varinfo`.
